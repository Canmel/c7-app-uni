<template>
	<view class="content">
		...
		<view class="qiun-bg-white qiun-title-bar qiun-common-mt" >
			<view class="qiun-title-dot-light">项目概况</view>
		</view>
		...
		<view class="qiun-bg-white qiun-title-bar qiun-common-mt" >
			<view class="qiun-title-dot-light">项目状态分布</view>
		</view>
		<view class="qiun-charts" >
		...
		<view class="qiun-bg-white qiun-title-bar qiun-common-mt" >
			<view class="qiun-title-dot-light">其他展示区域</view>
		</view>
		<view class="qiun-charts" >
...
export default {
	...
	methods: {
		...
		getColumnServerData(){
			...
			Column.categories.push("完成", "盯引项目", "推介项目", "在建项目", "落地项目");
			Column.series.push({
				"name": "工器具概况",
				"data": [15, {"value": 20,"color": "#f04864"}, 45, 37, 43]
			  });
